...
test_that("Cache doesn't get set until we turn it on", {
  ...
  with_fake_http({
    expect_GET(
      a <- fun("https://app.crunch.io/api/datasets"),
      "https://app.crunch.io/api/datasets"
    )
    expect_GET(
      b <- fun("https://app.crunch.io/api/", query = list(user = "me")),
...
without_internet({
  ...
  test_that("But uncached() prevents reading from the cache", {
    expect_error(
      uncached(fun("https://app.crunch.io/api/datasets")),
  ...
  test_that("We can disable caching", {
    expect_error(
      fun("https://app.crunch.io/api/datasets"),
      "GET https://app.crunch.io/api/datasets"
    )
  })
})
